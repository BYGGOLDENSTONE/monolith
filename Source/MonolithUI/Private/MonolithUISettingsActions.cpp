...
FMonolithActionResult FMonolithUISettingsActions::HandleScaffoldSaveGame(const TSharedPtr<FJsonObject>& Params)
{
    ...
    Cpp += TEXT("\t\tUE_LOG(") + LogCategory + TEXT(", Log, TEXT(\"Migrating save data from version %d to %d\"), LoadedVersion, LatestSaveVersion);\n");
    Cpp += TEXT("\t}\n");
    Cpp += TEXT("}\n\n");
    ...
    Cpp += TEXT("\n\tUE_LOG(") + LogCategory + TEXT(", Log, TEXT(\"Save data reset to defaults\"));\n");
    Cpp += TEXT("}\n");
...
FMonolithActionResult FMonolithUISettingsActions::HandleScaffoldSaveSubsystem(const TSharedPtr<FJsonObject>& Params)
{
    ...
    Cpp += TEXT("\tUE_LOG(") + LogCategory + TEXT(", Log, TEXT(\"Save subsystem initialized\"));\n");
    Cpp += TEXT("}\n\n");
    ...
    Cpp += TEXT("\t{\n");
    Cpp += TEXT("\t\tUE_LOG(") + LogCategory + TEXT(", Log, TEXT(\"Save %s: slot=%s\"), bSuccess ? TEXT(\"succeeded\") : TEXT(\"failed\"), *Slot);\n");
    ...
    Cpp += TEXT("\t{\n");
    Cpp += TEXT("\t\tUE_LOG(") + LogCategory + TEXT(", Warning, TEXT(\"No save in slot: %s\"), *SlotName);\n");
    ...
    Cpp += TEXT("\t\t\tUE_LOG(") + LogCategory + TEXT(", Log, TEXT(\"Save loaded from slot: %s\"), *Slot);\n");
    Cpp += TEXT("\t\t\tOnLoadComplete.Broadcast(true);\n");
    Cpp += TEXT("\t\t}\n");
    Cpp += TEXT("\t\telse\n");
    Cpp += TEXT("\t\t{\n");
    Cpp += TEXT("\t\t\tUE_LOG(") + LogCategory + TEXT(", Warning, TEXT(\"Failed to cast save from slot: %s\"), *Slot);\n");
    Cpp += TEXT("\t\t\tOnLoadComplete.Broadcast(false);\n");
    Cpp += TEXT("\t\t}\n");
    Cpp += TEXT("\t});\n\n");
