...
void MonolithUI::FRoundedCornerActions::Register(FMonolithToolRegistry& Registry)
{
    Registry.RegisterAction(
        ...
        FParamSchemaBuilder()
            ...
            .Optional(TEXT("corner_radii"), TEXT("array"), TEXT("At least four radii [TL,TR,BR,BL]; provide at least one style field"))
            .Optional(TEXT("outline_color"), TEXT("string"), TEXT("Color as #RGB, #RRGGBB, #RRGGBBAA, or R,G,B[,A]; omitted leaves the existing value"))
            .Optional(TEXT("outline_width"), TEXT("number"), TEXT("Outline width; omitted leaves existing value"))
            .Optional(TEXT("fill_color"), TEXT("string"), TEXT("Color as #RGB, #RRGGBB, #RRGGBBAA, or R,G,B[,A]; omitted leaves the existing value"))
