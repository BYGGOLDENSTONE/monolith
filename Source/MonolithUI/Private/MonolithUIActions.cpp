...
void FMonolithUIActions::RegisterActions(FMonolithToolRegistry& Registry)
{
    ...
    Registry.RegisterAction(
        ...
        FParamSchemaBuilder()
            ...
            .Optional(TEXT("value"), TEXT("any"), TEXT("Property value; value or property_value is required. When both are provided, value takes precedence. Accepts JSON scalar, array or object shapes supported by the property."))
            .Optional(TEXT("property_value"), TEXT("any"), TEXT("Fallback property value when value is absent; same supported JSON shapes"))
