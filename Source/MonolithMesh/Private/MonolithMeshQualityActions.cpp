...
void FMonolithMeshQualityActions::RegisterActions(FMonolithToolRegistry& Registry)
{
	...
	Registry.RegisterAction(TEXT("mesh"), TEXT("analyze_co_op_balance"),
		TEXT("Unavailable: co-op balance scoring is not implemented; returns a typed capability error without evaluating the world."),
...
{
	return FMonolithActionResult::NotImplemented(TEXT("co_op_balance_scoring"));
}
